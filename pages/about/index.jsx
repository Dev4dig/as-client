...
const About = () => {
    return <div className="page-about  min-h-[100vh] bg-black h-fit w-full">
    <Nav page={"about"}/>
    <MobileNav page={"about"}  />
    <div className="content flex min-content h-full w-full  ">
        <div className="left hidden lg:flex items-start justify-center min-h-[500px] p-2 pt-[80px] w-2/5">
...
kindly <a className="text-[#CC0909]" href="/contact">contact</a> us or make your booking <a href="/contact" className="text-[#CC0909]" >here</a>.
                </p>
            </div>
        </div>
    </div>
